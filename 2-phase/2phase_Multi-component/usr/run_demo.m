...
%       Mg       ||         Fe
CHM.C0.a  = 0.3;    CHM.C0.b  = 0.7;     % initial component fraction [wt%], must sum = 1
CHM.Tm0.a = 2000;	CHM.Tm0.b = 1800;	 % melting point at 0 Pressure
CHM.r.a   = 0.5;    CHM.r.b   = 0.5;     % curvature coefficient
% CHM.B.a   = 1e-8;   CHM.B.b   = 1e-8;    % Linear P coefficients
CHM.Hr.a  = 0;      CHM.Hr.b  = 0;       % radiogenic heating per component
% based on 
CHM.G.a   = 0.26;    CHM.G.b   = 0.6;   % Wt cotribution of component, must sum 1
CHM.dS    = 320; %Entropy gain of fusion
clap      = 6*1e-8; % linear P coefficient
perT = 0; perCs = 1; perCf = 1; PhDg = 0.5; % peritectic points

% set radioactive parameters
CHM.tau.Al = 1;

%% set initial condition
SOL.T0      =  1950;           	% reference/top potential temperature [C]
