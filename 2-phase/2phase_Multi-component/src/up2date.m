...
%% update T-C-dependent density
% MAT.Rho.s = PHY.Rho0.s.*(1 - MAT.aT.*(SOL.T-SOL.T0) -...
%             CHM.G.a.*(CHM.Cs.a-CHM.C0.a) - CHM.G.b.*(CHM.Cs.b-CHM.C0.b));    % solid density on centre nodes
% MAT.Rho.l = PHY.Rho0.l.*(1 - MAT.aT.*(SOL.T-SOL.T0) -...
%             CHM.G.a.*(CHM.Cl.a-CHM.C0.a) - CHM.G.b.*(CHM.Cl.b-CHM.C0.b));    % liquid
...
SOL.Ha = (1-SOL.phi(2:end-1,2:end-1)).*SOL.T(2:end-1,2:end-1).*MAT.aT(2:end-1,2:end-1).*dPdts...
    +SOL.phi(2:end-1,2:end-1) .*SOL.T(2:end-1,2:end-1).*MAT.aT(2:end-1,2:end-1).*dPdtl;
