...
NUM.nz      =  50;             % number of real z block nodes
NUM.nx      =  50;          	% number of real x block nodes
...
PHY.Eta0.s  =  1e20;    PHY.Eta0.l  =  1e1;        % reference viscosity [Pas]
PHY.aT0     =  3e-5;                               % thermal expansivity [1/K]
PHY.kT0     =  1;                                  % Thermal conductivity [W/m/K]
