...
MAT.k(NUM.PHI<=0)     = PHY.k0*SOL.philim^3;
...
PHY.RhoR.s(NUM.PHI<=0) = PHY.Rho0.a; PHY.RhoR.s(NUM.PHI>0) = PHY.Rho0.s; %solid density
PHY.RhoR.l(NUM.PHI<=0) = PHY.Rho0.a; PHY.RhoR.l(NUM.PHI>0) = PHY.Rho0.l; %solid density
...
MAT.Eta.s(NUM.PHI<=0) = PHY.Eta0.a; MAT.Eta.s(NUM.PHI>0) = PHY.Eta0.s; %solid density;
MAT.Eta.l  = MAT.Eta.l;
...
% shear heating above the free surface = 0; otherwise causes some high
% shear anomalies by the boundaries
SOL.Hs(NUM.PHI<=0) = 0;
