...
%        Mantle         ||      Air
Rho_mantle  =   3300;       Rho_air     =   1; % density
Eta_mantle  =   1e20;       Eta_air     =   1e17;% viscosity  
Alpha_mantle=   3e-5;       Alpha_air   =   0;% thermal expansion   
Cp_mantle   =   1000;       Cp_air      =   700;   % Volumetric heat capacity   
Kappa_mantle=   3;          Kappa_air   =   300;     % Thermal conductivity
Hr_mantle   =   2e-8;       Hr_air      =   0;% Radiogenic heat production
